...
Delete_TemporaryFiles()
{
	if [ -f $EXPORT_FILE ]
	then
		echo "Delete $EXPORT_FILE file"
		rm $EXPORT_FILE 
	fi
}
...
{
        scp /tmp/nxp-all-products-export nxp-user3@134.86.62.178:/tmp/nxp-node1-products-export
        ssh nxp-user3@134.86.62.178 "cat /tmp/nxp-node1-products-export >> /tmp/nxp-all-products-export"
}
